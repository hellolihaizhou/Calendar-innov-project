 ...
 *
 */
public class sortsAdapter  extends BaseAdapter
{
	private LayoutInflater mInflater;
	public Context mContext;
	public  List<sortsBean> mDatas;
	public sortsAdapter(Context context, List<sortsBean> Datas)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			convertView = mInflater.inflate(R.layout.sortslistview_item, parent,
					false);
			...
			viewHolder.img_bg=(ImageView)convertView.findViewById(R.id.img_bg);
		...
		viewHolder.img_bg.setBackgroundResource(mDatas.get(position).resid);;
